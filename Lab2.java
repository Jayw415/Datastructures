...
Queue<String> progLanguages = new LinkedList<>();
...
progLanguages.add("HTML", 2);
    ...
    Iterator<Character>Iter = progLanguages.terator();
    while(Iter.hasNext())
    {
      System.out.println(Iter.isNext() + " ");
    }
  }
